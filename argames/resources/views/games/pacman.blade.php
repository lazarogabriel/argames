...
<html>
	<head>
		...
		<link rel="stylesheet" type="text/css" href="{{ URL::asset('games/pacman/css/pacman.css')}}" />
		<link rel="stylesheet" type="text/css" href="{{ URL::asset('games/pacman/css/pacman-home.css')}}" />
	
		<script type="text/javascript" src="{{ URL::asset('games/pacman/js/jquery.js') }}"></script>
		<script type="text/javascript" src="{{ URL::asset('games/pacman/js/jquery-buzz.js') }}"></script>
		<script type="text/javascript" src="{{ URL::asset('games/pacman/js/game.js') }}"></script>
		<script type="text/javascript" src="{{ URL::asset('games/pacman/js/tools.js') }}"></script>
		<script type="text/javascript" src="{{ URL::asset('games/pacman/js/board.js') }}"></script>
		<script type="text/javascript" src="{{ URL::asset('games/pacman/js/paths.js') }}"></script>
		<script type="text/javascript" src="{{ URL::asset('games/pacman/js/bubbles.js') }}"></script>
		<script type="text/javascript" src="{{ URL::asset('games/pacman/js/fruits.js') }}"></script>
		<script type="text/javascript" src="{{ URL::asset('games/pacman/js/pacman.js') }}"></script>
		<script type="text/javascript" src="{{ URL::asset('games/pacman/js/ghosts.js') }}"></script>
		<script type="text/javascript" src="{{ URL::asset('games/pacman/js/home.js') }}"></script>
		<script type="text/javascript" src="{{ URL::asset('games/pacman/js/sound.js') }}"></script>
	...
	<body>
		...
		<div id="home">
			...
			<a class="sound" href="javascript:void(0);" data-sound="on"><img src="games/pacman/img/sound-on.png" alt="" border="0"></a>
		
		</div>
	
		<div id="panel">
            <h1 style="text-align: center">
                <img style="filter:invert(100%)" src="games/ahorcado/arrow-left-solid.svg" onclick="window.history.back();" width="30"> Back
                pac-man
            </h1>
