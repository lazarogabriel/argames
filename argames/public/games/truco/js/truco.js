...
//	'use strict';
	...
	*/
	...
	$(document).ready(function () {
		...
		//Cargo recursos
		var a = new Audio();
		a.setAttribute("src","games/truco/audio/envido.wav");
		a.load();
		audio.fx['E'] = a;
		a = new Audio();
		a.setAttribute("src","games/truco/audio/real-envido.wav");
		a.load();
		audio.fx['R'] = a;
		a = new Audio();
		a.setAttribute("src","games/truco/audio/falta-envido.wav");
		a.load();
		audio.fx['F'] = a;
		a = new Audio();
		a.setAttribute("src","games/truco/audio/quiero.wav");
		a.load();
		audio.fx['S'] = a;
		a = new Audio();
		a.setAttribute("src","games/truco/audio/no-quiero.wav");
		a.load();
		audio.fx['N'] = a;
		a = new Audio();
		a.setAttribute("src","games/truco/audio/truco.wav");
		a.load();
		audio.fx['T'] = a;
		a = new Audio();
		a.setAttribute("src","games/truco/audio/re-truco.wav");
		a.load();
		audio.fx['RT'] = a;
		a = new Audio();
		a.setAttribute("src","games/truco/audio/vale-cuatro.wav");
		a.load();
		audio.fx['V'] = a;
		//Comienza la acción
