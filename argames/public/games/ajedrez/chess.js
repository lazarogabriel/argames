	...
	*/
	...
	function showSolidBoard() {
		if (graphicsStatus === 0) {
			...
			XHR("games/ajedrez/meshes/board.json", function() {
				if (graphicsStatus === 0) { return; }
				etc.tmp3DBoard = eval("(" + this.responseText + ")");
				runComponents();
			});
			XHR("games/ajedrez/meshes/pawn.jscn", loadCom, 0);
			XHR("games/ajedrez/meshes/king.jscn", loadCom, 1);
			XHR("games/ajedrez/meshes/knight.jscn", loadCom, 2);
			XHR("games/ajedrez/meshes/bishop.jscn", loadCom, 3);
			XHR("games/ajedrez/meshes/rook.jscn", loadCom, 4);
			XHR("games/ajedrez/meshes/queen.jscn", loadCom, 5);
			XHR("games/ajedrez/canvas3dengine/scene.jsfb", loadCom, 6);
			XHR("games/ajedrez/canvas3dengine/vec3.jsfb", loadCom, 7);
			XHR("games/ajedrez/canvas3dengine/matrix3.jsfb", loadCom, 8);
			XHR("games/ajedrez/canvas3dengine/camera.jsfb", loadCom, 9);
			XHR("games/ajedrez/canvas3dengine/mesh.jsfb", loadCom, 10);
			XHR("games/ajedrez/canvas3dengine/light.jsfb", loadCom, 11);
			XHR("games/ajedrez/solidView.jsfb", loadCom, 12);
		} else {
